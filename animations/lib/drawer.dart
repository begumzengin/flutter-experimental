...
class DrawerApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(title: Text('drawer app', style: GoogleFonts.nunito())),
        body: Center(
          child: Text(
        ...
        drawer: Drawer(
          ...
          children: [
            DrawerHeader(
              ...
              child: Text('drawer header', style: GoogleFonts.nunito()),
            ),
            ListTile(
              title: Text('animated container', style: GoogleFonts.nunito()),
              onTap: () {
                Navigator.push(
                    context,
                    MaterialPageRoute(
            ...
            ListTile(
              title: Text('fade widget', style: GoogleFonts.nunito()),
              onTap: () {
            ...
            ListTile(
              title: Text('card dragger', style: GoogleFonts.nunito()),
              onTap: () {
                Navigator.push(
                    context,
                    MaterialPageRoute(
            ...
            ListTile(
              title: Text('page route builder', style: GoogleFonts.nunito()),
              onTap: () {
                Navigator.push(
            ...
            ListTile(
              title: Text('snackbar', style: GoogleFonts.nunito()),
              onTap: () {
                Navigator.push(context,
